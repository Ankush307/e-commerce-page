    ...
    return (
        <div className="px-4 pb-20">
            <div className="max-w-[1240px] w-full mx-auto">
                <h1 className="text-custom-4xl font-integral-cf font-bold mb-4">Your Cart</h1>
                        ...
                        <div className="w-full max-w-[715px]">
                            <div className="w-full py-5 px-6 border border-solid border-black/10 rounded-[20px]">
                                {cartItems.map((item, index) => (
                                    <div className={`flex gap-4 ${cartItems.length > 1 && "pb-6"} ${index === 0 ? "" : "border-t border-solid border-black/10 pt-6"} ${index === cartItems.length - 1 && "!pb-0"}`} key={index}>
                                        ...
                                        <div className="flex flex-col w-full">
                                            ...
                                            <p className="text-sm leading-[100%] text-black"> Size: <span className="text-gray mt-0.5">{item.selectedSize}</span></p>
                                            <p className="text-sm leading-[100%] text-black"> Color: <span className="text-gray mt-1">{item.selectedColor}</span></p>
                                            <div className="flex justify-between mt-1.5 items-baseline">
                                                <p className="font-bold text-2xl leading-[100%]"> ${item.price * item.quantity}</p>
