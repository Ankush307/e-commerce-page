        ...
        <div className="max-w-[505px] w-full relative">
            <div className=" max-h-[458px] lg:sticky lg:top-0 py-5 border border-solid border-black/10 rounded-[20px] w-full px-6 flex flex-col gap-6">
                ...
                <form className="flex w-full items-center gap-3">
                    <div className="w-full bg-light-blue items-center flex gap-3  rounded-[62px] py-3 px-4"><PromoCodeIcon />
                        <input type="text" className="outline-none uppercase text-black/40" placeholder="Add promo code" />
                    </div>
                ...
                <button className="gap-[14.63px] flex py-[19px] w-full justify-center items-center group bg-black text-white hover:bg-white hover:text-black font-medium" onClick={onClick} ><ArrowIcon pathClass="group-hover:fill-black" /> Go to Checkout</button>
            </div>
        </div>
    );
};
